    ...
    <div className="card vote-card">
          ...
          <div className="proof-status">
            {voteStatus === "generating_proof" && (
              <>
                ...
                <p className="proof-sub">Your vote is being cryptographically sealed</p>
              </>
            )}
            {voteStatus === "submitting" && (
              <>
                <p className="proof-main">Submitting to Preprod…</p>
                <p className="proof-sub">Broadcasting transaction to Midnight network</p>
              </>
            )}
          </div>
        </div>
      ...
      {voteStatus === "confirmed" && lastTxHash && (
        <div className="vote-confirmed">
          ...
          <p className="confirm-sub">Your private vote was recorded on-chain</p>
